...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-smart-campus-key-change-in-production-2026')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.environ.get('DEBUG', 'True').lower() in ('true', '1', 'yes')

ALLOWED_HOSTS = os.environ.get('ALLOWED_HOSTS', 'localhost,127.0.0.1,.railway.app,.onrender.com,.azurewebsites.net').split(',')
...
# Database
# Use DATABASE_URL for production (Railway, Render, Heroku)
...
# CORS settings for mobile app (iOS/Android)
CORS_ALLOW_ALL_ORIGINS = DEBUG  # Only allow all in development
CORS_ALLOWED_ORIGINS = [
    'http://localhost:3000',
    'http://127.0.0.1:3000',
    # Add your iOS app scheme here when ready
]
